...
final servicesStreamProvider = StreamProvider.family
    .autoDispose<List<Service>, CategoryId?>((ref, categoryId) {
  final query = categoryId != null
      ? "SELECT * FROM services WHERE services.category_id = '$categoryId' ORDER BY name_en ASC"
